...
inline std::vector<NativeCompletionItem> queryNativeCommandCompletionsForShell(
...
inline std::vector<NativeCompletionItem> queryNativeOptionCompletionsForShell(
...
inline std::vector<NativeCompletionItem> queryNativeCommandCompletions(
    std::string_view prefix) noexcept {
  return queryNativeCommandCompletionsForShell(prefix, false);
}

inline std::vector<NativeCompletionItem> queryNativeOptionCompletions(
